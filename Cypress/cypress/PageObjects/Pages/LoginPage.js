import loginData from '../../e2e/Data/testData.json'
class LoginPage {
 ...
 /**
  ...
  performLoginWithInvalidCredentials() {
    const username = loginData.InvalidLogin[0].InvalidUserName;
    const password = loginData.InvalidLogin[1].InvalidPassword;
